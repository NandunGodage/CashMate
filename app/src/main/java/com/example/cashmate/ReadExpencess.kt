...
class ReadExpencess : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val myRef = database.getReference("Expencess").limitToLast(1)
        ...
        deleteButton.setOnClickListener {
            ...
            val intent = Intent(this@ReadExpencess, ReadExpencess::class.java)
            startActivity(intent)
        }

        val editButton: Button = findViewById(R.id.edit)
        editButton.setOnClickListener {
            val intent = Intent(this@ReadExpencess, EditExpencess::class.java)
