...
import com.example.influxapp.model.Expencess
import com.example.influxapp.model.Income
import com.google.firebase.database.DatabaseReference
import com.google.firebase.database.FirebaseDatabase

class AddExpencess : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        databaseRef = FirebaseDatabase.getInstance().getReference("Expencess")
        ...
        submitButton.setOnClickListener {
            ...
            val Expencess = Expencess(category,  amount)

            // Add the Income object to the Firebase Realtime Database
            databaseRef.push().setValue(Expencess)
                .addOnSuccessListener {
                    // Show a success message to the user
                    Toast.makeText(this, "Expencess added successfully", Toast.LENGTH_LONG).show()
                    ...
                    val intent = Intent(this, ReadExpencess::class.java)
                ...
                .addOnFailureListener {
                    ...
                    Toast.makeText(this, "Failed to add Expencess", Toast.LENGTH_LONG).show()
                }
        }
    }
}
